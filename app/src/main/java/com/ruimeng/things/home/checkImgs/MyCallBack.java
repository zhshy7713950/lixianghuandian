...
public class MyCallBack extends ItemTouchHelper.Callback {
    ...
    public static int getPixelById(int dimensionId) {
        return Wongxd.Companion.getInstance().getResources().getDimensionPixelSize(dimensionId);
    }
    ...
    public MyCallBack(PostImgAdapter adapter, List<String> images, List<String> originImages) {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (recyclerView.getLayoutManager() instanceof StaggeredGridLayoutManager ||
                recyclerView.getLayoutManager() instanceof LinearLayoutManager) {//设置能拖拽的方向
