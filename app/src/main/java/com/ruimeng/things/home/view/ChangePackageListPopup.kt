...
class ChangePackageListPopup (private val activity: Activity,
    ...
    init {
        ...
        if (option1 != null){
            contentView.findViewById<TextView>(R.id.tv_change_package_name1).text = option1.name
        ...
        if (option2 != null){
            contentView.findViewById<TextView>(R.id.tv_change_package_name2).text = option2.name
