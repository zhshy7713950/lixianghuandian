package com.ruimeng.things.me.widget.signature_view;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        mMinWidth = convertDpToPx(3);
        mMaxWidth = convertDpToPx(7);
        ...
        // Dirty rectangle to update only the changed portion of the webView
