package com.ruimeng.things.shop.refreshview;
...
import com.ruimeng.things.shop.refreshview.callback.IFooterCallBack;
import com.ruimeng.things.shop.refreshview.listener.IScrollTopListener;
import com.ruimeng.things.shop.refreshview.listener.OnBottomLoadMoreTime;
import com.ruimeng.things.shop.refreshview.listener.OnTopRefreshTime;
import com.ruimeng.things.shop.refreshview.recyclerview.BaseRecyclerAdapter;
import com.ruimeng.things.shop.refreshview.recyclerview.XSpanSizeLookup;
import com.ruimeng.things.shop.refreshview.utils.LogUtils;
import com.ruimeng.things.shop.refreshview.utils.Utils;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime, OnBottomLoadMoreTime {
    ...
    private IScrollTopListener mIScrollTopListener;


    public IScrollTopListener getmIScrollTopListener() {
        return mIScrollTopListener;
    }

    public void setmIScrollTopListener(IScrollTopListener mIScrollTopListener) {
        this.mIScrollTopListener = mIScrollTopListener;
    }
        ...
        if (child instanceof XScrollView) {
            ...
            scrollView.setOnScrollListener(mParent, new XScrollView.OnScrollListener() {
                ...
                public void onScrollStateChanged(ScrollView view, int scrollState, boolean arriveBottom) {
                    if (scrollState == OnScrollListener.SCROLL_STATE_IDLE && arriveBottom) {
                        if (mSilenceLoadMore) {
...
//        mTotalItemCount = 0;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (mIScrollTopListener!=null){
            mIScrollTopListener.onScrollStateChanged(view,scrollState);
        }
