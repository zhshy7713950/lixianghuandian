...
object QuickLoginHelper {
    ...
    private fun setUnifyUiConfig() {
        ...
        getQuickLoginInstance().setUnifyUiConfig(UnifyUiConfig.Builder().apply {
            //导航栏
            setNavigationBackgroundColor(context.resources.getColor(com.ruimeng.things.R.color.app_color))
            setHideNavigationBackIcon(true)
            setNavigationHeight(45)
            setNavigationTitle(context.getString(com.ruimeng.things.R.string.app_name))
            ...
            val tvAppName = TextView(context).also {
                ...
                it.textColor = Color.parseColor("#232524")
                it.textSize = 20f
            ...
            //手机号码
            setMaskNumberColor(Color.parseColor("#232524"))
            setMaskNumberSize(28)
            setMaskNumberTopYOffset(180)

            //运营商
            setSloganSize(12)
            setSloganColor(Color.parseColor("#232524"))
            setSloganTopYOffset(220)
            ...
            setLoginBtnTopYOffset(270)
            setLoginBtnBackgroundDrawable(context.getDrawable(com.ruimeng.things.R.drawable.bg_btn_common1))

            setHideNavigation(false)
            setStatusBarColor(context.resources.getColor(com.ruimeng.things.R.color.app_color))
            ...
            val button = Button(context).also {
                ...
                it.textColor = Color.parseColor("#55bb87")
                it.textSize = 16f
                it.layoutParams = RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,45.dp2px().toInt()).also {mpls ->
            ...
            setPrivacyProtocolColor(Color.parseColor("#55bb87"))
