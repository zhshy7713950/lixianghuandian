...
public class CaocConfig implements Serializable {
    ...
    //upload error log listener
    private CustomActivityOnCrash.UploadErrorListener uploadErrorListener = null;
    ...
    public CustomActivityOnCrash.UploadErrorListener getUploadErrorListener() {
        return uploadErrorListener;
    }

    public void setUploadErrorListener(CustomActivityOnCrash.UploadErrorListener uploadErrorListener) {
        this.uploadErrorListener = uploadErrorListener;
    }
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            config.uploadErrorListener = currentConfig.uploadErrorListener;
        ...
        public Builder uploadErrorListener(CustomActivityOnCrash.UploadErrorListener uploadErrorListener) {
            if (uploadErrorListener != null) {
                config.uploadErrorListener = uploadErrorListener;
            }
            return this;
        }
