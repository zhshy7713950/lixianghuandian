 ...
 * openhelper
 */
open class DatabaseOpenHelper private constructor(ctx: Context, dbName: String, dbVersion: Int = 1)
    ...
    private lateinit var columns: Array<Pair<String, SqlType>>
    ...
    open fun upgradeTable(tableName: String, oldVersion: Int, newVersion: Int) {
        DatabaseOpenHelper.tableName = tableName
        onUpgrade(writableDatabase, oldVersion, newVersion)
