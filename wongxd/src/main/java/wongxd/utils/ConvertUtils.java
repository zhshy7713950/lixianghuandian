...
public final class ConvertUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = Wongxd.Companion.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = Wongxd.Companion.getInstance().getResources().getDisplayMetrics().scaledDensity;
