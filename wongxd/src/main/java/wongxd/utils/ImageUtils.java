...
import wongxd.utils.compression.Luban;
...
public class ImageUtils {
    ...
    /**
     * 写图片文件 在Android系统中，文件保存在 /data/data/PACKAGE_NAME/imgs 目录下
     * 
     * @throws IOException
     */
     ...
     * 压缩多张图片 RxJava 方式
     */
    public static void compressWithRx(Context ctx,List<String> files, Observer observer) {
     ...
     * 压缩单张图片 RxJava 方式
     */
    public static void compressWithRx(Context ctx,String url, Consumer consumer) {
